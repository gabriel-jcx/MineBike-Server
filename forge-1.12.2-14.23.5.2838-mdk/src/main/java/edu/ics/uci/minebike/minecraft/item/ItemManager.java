...
public class ItemManager {
    ...
    public static final CookLettuceHead LETTUCEHEAD = new CookLettuceHead();
    ...
    public static void register(IForgeRegistry<Item> registry) {
        registry.registerAll(new Item[]{GAME_FISHING_ROD,BURGER,BURGER_BUN, SANDWICH,SANDWICH_BREAD,LETTUCE,LETTUCEHEAD});
    }
    ...
    public static void registerModels() {
        ...
        LETTUCEHEAD.registerItemModel(LETTUCEHEAD);
